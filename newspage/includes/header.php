<!-- file chứa nội dung cuối cùng của mỗi trang giao diện như các popup thông báo, kết nối các thư viện JS... -->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    if ($db->db_num_rows($sql_get_list_menu_1)) {
                        // In chuyên mục cấp 1
                        foreach ($db->db_fetch_assoc($sql_get_list_menu_1, 0) as $data_menu_1) {
                            ...
                            if ($db->db_num_rows($sql_get_list_menu_2)) {
                                // In chuyên mục cấp 2
                                $sub_menu = '<ul class="dropdown-menu">';
                                foreach ($db->db_fetch_assoc($sql_get_list_menu_2, 0) as $data_menu_2) {
