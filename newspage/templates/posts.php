<!-- trang show bài viết theo url chỉ định -->
<?php
...
if ($db->db_num_rows($sql_get_data_post)) {
...
<div class="container">
    ...
    <div class="row">
        ...
        if ($db->db_num_rows($sql_get_invole_post)) {
            // In danh sách bài viết liên quan
            foreach ($db->db_fetch_assoc($sql_get_invole_post, 0) as $data_post) {
                echo '
                    <div class="col-md-3">
                        <div class="thumbnail">
