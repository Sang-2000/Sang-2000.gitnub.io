...
if ($user)
{
    ...
    if ($ac != '') 
    {
        ...
        if ($ac == 'add')
        {
            ...
            '
                <p class="form-up-img">
                    <div class="alert alert-info">Mỗi lần upload tối đa 20 file ảnh. Mỗi file có dung lượng không vượt quá 5MB và có đuôi định dạng là .jpg, .png, .gif, .jpeg </div>
                    ...
                    <div class="col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <p>Ngày upload: ' . $data_img['date_uploaded'] . '</p>
                            </div>
                        </div>
                    </div>   
                ';
