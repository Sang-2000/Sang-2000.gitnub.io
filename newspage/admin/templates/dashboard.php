...
<div class="row">
    ...
    if ($data_user['position'] == '1') {
        ...
        $count_all_post = $db->db_num_rows($sql_get_count_all_post);
    ...
    ';
        ...
        $count_post_author = $db->db_num_rows($sql_get_count_post_author);
    ...
    <div class="col-md-4">
        <div class="alert alert-success">
            ...
            echo $db->db_num_rows($sql_get_count_post_public);
    ...
    <div class="col-md-4">
        ...
        <h1>
            ...
            echo $db->db_num_rows($sql_get_count_post_hide);
...
<div class="row">
    ...
    $count_cate_1 = $db->db_num_rows($sql_get_count_cate_1);
    ...
    $count_cate_2 = $db->db_num_rows($sql_get_count_cate_2);
    ...
    $count_cate_3 = $db->db_num_rows($sql_get_count_cate_3);
