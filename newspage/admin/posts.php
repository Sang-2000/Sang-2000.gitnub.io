    ...
    if (isset($_POST['action']))
    {
        ...
        if ($action == 'add_post')
        {
            ...
            else
            {
                ...
                if ($db->db_num_rows($sql_check_post_exist))
                {
        ...
        else if ($action == 'load_cate_2')
        {
            ...
            if ($db->db_num_rows($sql_get_cate_2)) {
                foreach ($db->db_fetch_assoc($sql_get_cate_2, 0) as $key => $data_cate_2) {
        ...
        else if ($action == 'load_cate_3')
        {
            ...
            if ($db->db_num_rows($sql_get_cate_3)) {
                foreach ($db->db_fetch_assoc($sql_get_cate_3, 0) as $key => $data_cate_3) {
        ...
        else if ($action == 'edit_post')
        {
            ...
            else if (!$db->db_num_rows($sql_check_id_post))
            {
        ...
        else if ($action == 'search_post')
        {
            ...
            if ($kw_search_post != '')
            {
                ...
                // Nếu có kết quả
                if ($db->db_num_rows($sql_search_post)) 
                {
                    echo
                    '
                    ...
                    foreach ($db->db_fetch_assoc($sql_search_post, 0) as $key => $data_post) 
                    {
                        // Trạng thái bài viết
